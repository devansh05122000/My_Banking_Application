...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    private com.example.mybanking.ViewHolder.ClickListener mClickListener;
    public interface  ClickListener{
        void onItemClick(View view, int position);
    }

    public void setOnClickListener(com.example.mybanking.ViewHolder.ClickListener clickListener){
